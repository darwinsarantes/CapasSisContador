    ...
    public class ConfiguracionAD
    {
        ...
        public bool ListadoPorIdentificador(ConfiguracionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select IdConfiguracion, RutaRespaldos, RutaRespaldosDeExcel,NivelesDeLaCuenta,PathMysSQLDump,PathMySQL from configuracion where IdConfiguracion = {0} ", oRegistroEN.IdConfiguracion);
                Comando.CommandText = Consultas;
